...
var Showoff = require('./components/leaderboard.jsx');
var TopBar = require('./components/leaderboard.jsx');
...
React.render(React.createElement(Leaderboard, {players: players}), document.getElementById('blah'));
React.render(React.createElement(Showoff, {leader: players[0]}), document.getElementById('showoff'));
React.render(React.createElement(TopBar, null), document.getElementById('topbar'));

},{"./components/leaderboard.jsx":2,"react":158}],2:[function(require,module,exports){
var React = require('react');
