...
function render(data) {
  ...
  React.render(React.createElement(Viilo, {players: players, leader: players[0]}), document.getElementById('viilo'));
}

},{"./components/viilo.jsx":5,"react":161,"superagent":162}],2:[function(require,module,exports){
var React = require('react');
      ...
      if (player.provisional) {
        return (
          React.createElement("tr", {key: player.id, className: "provisional"}, 
            ...
            React.createElement("td", {className: "name"}, player.name), 
            ...
            React.createElement("td", {width: "10%", className: "streak"}, player.streak), 
            React.createElement("td", {width: "15%", className: "lastten"}, player.lastTen)
          )
        );
      } else {
        return (
    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {style: wrapperDivStyle}, 
          React.createElement(Showoff, {leader: this.props.leader}), 
...
},{"./leaderboard.jsx":2,"./showoff.jsx":3,"./top-bar.jsx":4,"react":161}],6:[function(require,module,exports){
