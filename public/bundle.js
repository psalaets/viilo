...
function render(data) {
  ...
  React.render(React.createElement(Viilo, {players: players, leader: players[0], resultReported: submitResult}), document.getElementById('viilo'));
}

},{"./components/viilo.jsx":6,"react":162,"superagent":163}],2:[function(require,module,exports){
var React = require('react');
...
var Leaderboard = React.createClass({displayName: "Leaderboard",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {"data-leaderboard": true}, 
        React.createElement("h2", null, "Rankings"), 
          ...
          React.createElement("thead", null, 
            React.createElement("tr", null, 
              ...
              React.createElement("th", null, 
                React.createElement("div", {className: "winlose"}, 
                  React.createElement("span", {className: "win-heading"}, React.createElement("i", {className: "fa fa-trophy"})), 
                  React.createElement("span", {className: "muted"}, "-"), 
                  React.createElement("span", {className: "lose-heading"}, React.createElement("i", {className: "fa fa-frown-o"}))
                )
              ), 
              ...
              React.createElement("th", {className: "lastten-heading"}, React.createElement("i", {className: "fa fa-history"}), " 10")
            )
          ), 
  ...
  rankedRow: function(player) {
    return (
      React.createElement("tr", {key: player.id}, 
        React.createElement("td", {className: "rank"}, player.rank), 
        React.createElement("td", {className: "name"}, player.name, " ", this.playerEloDelta(player)), 
        React.createElement("td", {width: "15%", className: "elo"}, player.elo), 
        React.createElement("td", {width: "8%"}, 
          React.createElement("div", {className: "winlose"}, 
            React.createElement("span", {className: "win"}, player.wins), 
            React.createElement("span", {className: "muted"}, "-"), 
            React.createElement("span", {className: "lose"}, player.losses)
          )
        ), 
        React.createElement("td", {width: "10%", className: "percent"}, this.winningPercentage(player)), 
        React.createElement("td", {width: "10%", className: "streak"}, this.streak(player.streak)), 
        React.createElement("td", {width: "10%", className: "lastten"}, this.lastTen(player.lastTen))
      )
    );
  },
  provisionalRow: function(player) {
    return (
      React.createElement("tr", {key: player.id, className: "provisional"}, 
      React.createElement("td", {className: "rank"}, player.rank), 
      React.createElement("td", {className: "name"}, player.name, " ", this.playerEloDelta(player)), 
      React.createElement("td", {width: "15%", className: "elo"}, player.elo), 
      React.createElement("td", {width: "8%"}, 
...
var PlayerSelector = React.createClass({displayName: "PlayerSelector",
  ...
  render: function() {
    ...
    // default option
    options.unshift(React.createElement("option", {key: "", value: ""}, this.props.defaultOptionText))

    return (
      React.createElement("select", {className: "player-select", ref: "select", value: this.state.selectedId, onChange: this.handleSelection}, 
        options
      )
    );
  },
...
var Showoff = React.createClass({displayName: "Showoff",
  propTypes: {
  ...
  render: function() {
    return (
      React.createElement("div", {"data-showoff": true}, 
        /* TODO move this into its own component */
        React.createElement("div", {"data-showoff-panel": "selector"}, 
          React.createElement("span", {className: "subtitle"}, "Report Result"), 
          ...
          React.createElement("span", {className: "radical"}, "has defeated"), 
          React.createElement(PlayerSelector, {
            ref: "loserList", 
          ...
          React.createElement("div", {className: "controls"}, 
            React.createElement("button", {onClick: this.handleResultReported}, "Submit"), 
            React.createElement("button", {onClick: this.handleReset}, "Reset")
          )
        ), 

        React.createElement("div", {"data-showoff-panel": "king"}, 
          React.createElement("span", {className: "subtitle"}, "Currently Dominating"), 
          React.createElement("h2", {className: "king"}, React.createElement("i", {className: "fa fa-trophy"}), " ", this.props.leader.name)
        )
  ...
  render: function () {
    ...
    return (
      React.createElement("div", null, 
        ...
        React.createElement("div", {style: wrapperDivStyle}, 
          React.createElement(Showoff, {leader: this.props.leader, playersByName: this.playersByName(), resultReported: this.props.resultReported}), 
