...
var Leaderboard = React.createClass({displayName: "Leaderboard",
  ...
  render: function() {
    ...
    return (
      React.createElement("div", {"data-leaderboard": true}, 
        React.createElement("h2", null, "Rankings - ", React.createElement("strong", null, "Season 3")), 
  ...
  tierHeaderRow: function(tier) {
    ...
    return (
      React.createElement("tr", {key: 'tier-' + tier + '-header'}, React.createElement("td", {colSpan: columns}, tierName))
    );
  },
  playerRow: function(player) {
    ...
    return (
      React.createElement("tr", {key: player.id, className: rowClass}, 
