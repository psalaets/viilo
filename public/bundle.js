  ...
  tierHeaderRow: function(tier) {
    ...
    return (
      React.createElement("tr", {className: 'great-primer tier tier-' + tierName, key: 'tier-' + tier + '-header'}, 
        React.createElement("td", {colSpan: columns}, tierName)
      )
    );
  },
  playerRow: function(player) {
    ...
    return (
      React.createElement("tr", {key: player.id, className: rowClass, "data-player-id": player.id}, 
        ...
        React.createElement("td", {className: "name"}, React.createElement("strong", null, player.name), " ", this.playerEloDelta(player)), 
        ...
        React.createElement("td", {className: "percent"}, this.winningPercentage(player)), 
        React.createElement("td", {className: "streak"}, this.streak(player.streak)), 
        React.createElement("td", {className: "lastten"}, this.lastTen(player.lastTen))
      )
    );
  },
  ...
  render: function () {
    ...
    return (
      React.createElement("main", null, 
        ...
        React.createElement("section", {"data-container": true}, 
          React.createElement("h2", {className: "trafalgar", style: styles}, "Rankings - Season 3"), 
