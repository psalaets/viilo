        ...
        React.createElement("table", null, 
          React.createElement("thead", null, 
            React.createElement("tr", null, 
              ...
              React.createElement("th", {className: "win-heading"}, React.createElement("i", {className: "fa fa-trophy"})), 
              React.createElement("th", {className: "lose-heading"}, React.createElement("i", {className: "fa fa-frown-o"})), 
  ...
  rankedRow: function(player) {
    return (
      React.createElement("tr", {key: player.id}, 
        ...
        React.createElement("td", {width: "10%", className: "win"}, player.wins), 
        React.createElement("td", {width: "10%", className: "lose"}, player.losses), 
        React.createElement("td", {width: "10%", className: "streak"}, this.streak(player.streak)), 
        React.createElement("td", {width: "15%", className: "lastten"}, this.lastTen(player.lastTen))
      )
    );
  },
  provisionalRow: function(player) {
    return (
      React.createElement("tr", {key: player.id, className: "provisional"}, 
        React.createElement("td", {className: "rank"}, "P"), 
        React.createElement("td", {className: "name"}, player.name, " ", this.playerEloDelta(player)), 
        React.createElement("td", {width: "15%", className: "elo"}, player.elo), 
        React.createElement("td", {width: "10%", className: "win"}, player.wins), 
        React.createElement("td", {width: "10%", className: "lose"}, player.losses), 
...
var PlayerSelector = React.createClass({displayName: "PlayerSelector",
  ...
  render: function() {
    ...
    return (
      React.createElement("select", {ref: "select", value: this.state.selectedId, onChange: this.handleSelection}, 
        options
      )
    );
  },
