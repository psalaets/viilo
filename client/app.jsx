...
React.render(<Leaderboard players={players}/>, document.getElementById('blah'));
React.render(<Showoff leader={players[0]}/>, document.getElementById('showoff'));
React.render(<TopBar/>, document.getElementById('topbar'));